			...
			<div style={{marginTop:'-30px'}} className="user_card">
				...
				<div className="d-flex justify-content-center form_container">
					<form> 
                        ...
                        <div className="input-group mb-3 gap-3">
							<div className="input-group-append">
								<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-align-top" viewBox="0 0 16 16">
						...
						<div className="input-group mb-3 gap-3">
							<div className="input-group-append">
								<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
						...
						<div className="input-group mb-3 gap-3">
							<div className="input-group-append">
								<svg xmlns="http://www.w3.org/2000/svg" width="36" height="30" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
