...
const PostFooter = (props) => {
  return (
    ...
    <div className='d-flex align-items-center gap-1'>
       <button style={{color:'lightblue',marginLeft:'15px'}} >
      ...
      <span style={{fontSize:'11px',marginLeft:'0px'}}>{props.participant.likes}</span> 
    </div>
    <div className='d-flex align-items-center gap-1'>
       ...
       <span style={{fontSize:'10px',color:'pink'}}>Votes</span> 
